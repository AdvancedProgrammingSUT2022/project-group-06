...
public class GameMenu extends Menu {
    ...
    private static String technologiesView(Scanner scanner) {
        ...
        if (command.equals("Exit")) return "exited research menu";
    ...
    public static boolean startGame() {
        ...
        while (true) {
            ...
            } else if (!mapCommands(command)) System.out.println("invalid command");
        }
    ...
    private static void selectMilitary(int x, int y) {
        if (GameController.isOutOfBounds(x, y)) System.out.println("Entered position is not valid");
        else if (!UnitController.hasMilitary(x, y)) System.out.println("There is no military unit in this hex");
    ...
    private static void selectCivilian(int x, int y) {
        if (GameController.isOutOfBounds(x, y)) System.out.println("Entered position is not valid");
        else if (!UnitController.hasCivilian(x, y)) System.out.println("There is no civilian unit in this hex");
